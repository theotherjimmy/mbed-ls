...
class CLIComands(unittest.TestCase):
    ...
    def test_print_version(self):
        ...
        self.assertIn(
            pkg_resources.require("mbed-ls")[0].version, self.stdout.getvalue()
        )
    ...
    def test_mbeds_as_json(self):
        ...
        self.assertEqual(
            self.mbeds.list_mbeds.return_value, json.loads(self.stdout.getvalue())
        )
    ...
    def test_json_platforms(self):
        ...
        platform_names = [
            d["platform_name"] for d in self.mbeds.list_mbeds.return_value
        ]
    ...
    def test_list_platform(self):
        ...
        self.assertIn(
            self.mbeds.list_manufacture_ids.return_value, self.stdout.getvalue()
        )
